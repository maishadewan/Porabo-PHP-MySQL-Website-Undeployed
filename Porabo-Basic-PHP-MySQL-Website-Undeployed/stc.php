      ...
      $pai=0;
          ...
          if ($result2= $conn->query($p)) {
            while( $row2 = $result2->fetch_assoc()) {
              ...
              if($class==$row2["from_class"] or $class==$row2["to_class"] or ($class <$row2["to_class"] and $class >$row2["from_class"] ) and ($row2["salary_expectation"]==$sa ||$row2["salary_expectation"]<$sa )){
